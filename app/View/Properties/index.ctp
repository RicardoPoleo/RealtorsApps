<div class="properties index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('users_email'); ?></th>
			...
			<th><?php echo $this->Paginator->sort('propertytype'); ?></th>
	...
	<tr>
		...
		<td><?php echo h($property['Property']['users_email']); ?>&nbsp;</td>
		...
		<td><?php echo h($property['Property']['dealtype']); ?>&nbsp;</td>
		<td><?php echo h($property['Property']['price']); ?>&nbsp;</td>
		<td><?php echo h($property['Property']['propertytype']); ?>&nbsp;</td>
		<td><?php echo h($property['Property']['amenities']); ?>&nbsp;</td>
		<td><?php echo h($property['Property']['size']); ?>&nbsp;</td>
		<td><?php echo h($property['Property']['datecreation']); ?>&nbsp;</td>
		<td class="actions">
